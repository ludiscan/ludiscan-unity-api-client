...
namespace LudiscanApiClient.Runtime.ApiClient.Dto.Model
{
    ...
    public partial class HeatmapTaskListItemDto
    {
        ...
        */
        ...
        public HeatmapTaskListItemDto(decimal taskId = default(decimal), ProjectResponseDto project = default(ProjectResponseDto), PlaySessionResponseDto session = default(PlaySessionResponseDto), decimal stepSize = default(decimal), bool zVisible = default(bool), StatusEnum status = default(StatusEnum), DateTime createdAt = default(DateTime), DateTime updatedAt = default(DateTime))
        {
            this.TaskId = taskId;
