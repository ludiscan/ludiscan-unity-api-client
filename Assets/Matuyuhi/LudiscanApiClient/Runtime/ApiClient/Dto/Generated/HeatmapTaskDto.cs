...
namespace LudiscanApiClient.Runtime.ApiClient.Dto.Model
{
    ...
    public partial class HeatmapTaskDto
    {
        ...
        */
        ...
        public HeatmapTaskDto(decimal taskId = default(decimal), ProjectResponseDto project = default(ProjectResponseDto), PlaySessionResponseDto session = default(PlaySessionResponseDto), decimal stepSize = default(decimal), bool zVisible = default(bool), StatusEnum status = default(StatusEnum), List<HeatMapTaskResultListItem> result = default(List<HeatMapTaskResultListItem>), DateTime createdAt = default(DateTime), DateTime updatedAt = default(DateTime))
        {
            this.TaskId = taskId;
